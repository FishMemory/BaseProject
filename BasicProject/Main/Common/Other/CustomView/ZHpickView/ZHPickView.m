...
-(UIToolbar *)setToolbarStyle{
    ...
    UIButton *cancelBtn = [DLButton buttonType:UIButtonTypeSystem frame:FRAME(0, 0, 44, 30) titleColor:nil target:self Selector:@selector(remove) selectorState:UIControlEventTouchUpInside title:@"取消" cornerRadius:0];
    ...
    UIButton *doneBtn = [DLButton buttonType:UIButtonTypeSystem frame:FRAME(0, 0, 44, 30) titleColor:nil target:self Selector:@selector(doneClick) selectorState:UIControlEventTouchUpInside title:@"确定" cornerRadius:0];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, ZHToobarHeight, SCREEN_WIDTH/3, ZHToobarHeight)];
