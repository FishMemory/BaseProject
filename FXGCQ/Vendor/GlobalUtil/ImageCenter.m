...
// 校友主页背景 裁剪
+(NSData *)cuImageWithData:(NSData *) data{
    UIImage *image = [UIImage imageWithData:data];
    UIView *imageV = [[UIView alloc]initWithFrame: FRAME(0, 0, SCREEN_WIDTH, 0.45*SCREEN_WIDTH)];
    UIImage *imageSender = [ImageCenter  cutImage:image bgImgView:imageV];
    NSData *datas = UIImageJPEGRepresentation(imageSender,0.5);
    return datas;
}

//裁剪图片
+ (UIImage *)cutImage:(UIImage*)image bgImgView:(UIView *)bgImgView
{
